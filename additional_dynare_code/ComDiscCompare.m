...
VarYcommit=oo_.var(5,5);% Variance of output
VarPicommit=oo_.var(3,3);% Variance of inflation
LossCommit = VarPicommit+lambda*VarYcommit;
...
VarYdisc=oo_.var(5,5);% Variance of output
VarPidisc=oo_.var(3,3);% Variance of inflation
LossDisc = VarPidisc+lambda*VarYdisc;
